...
class GuideProfileDetails extends StatefulWidget {
  List list;
  int index;
  GuideProfileDetails({this.index,this.list});
  @override
  State<StatefulWidget> createState() => GuideProfileDetailsState();
}

class GuideProfileDetailsState extends State<GuideProfileDetails> {
  @override
